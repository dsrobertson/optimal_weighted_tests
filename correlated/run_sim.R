...
save(dPoS, file = paste0('2_treatments_sim1_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p2 + 
  plot_annotation(title = paste0("<b>&theta;</b> = (0, &theta;) and &rho; = ", rho), 
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) +
  plot_layout(nrow = 2)

ggsave(paste0('PoS_2T_sim1_', 100*rho, '.pdf'), PoS_plots,
              width = 20, height = 16, units = "cm", device = cairo_pdf)
...
save(dPoS, mPoS.H1, mPoS.H2,
     file = paste0('2_treatments_sim2_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p1.H1 + p1.H2 + 
  ...
  plot_annotation(title = paste0("<b>&theta;</b> = (&theta;/2, &theta;) and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) +
  plot_layout(guides = "collect") & 
  theme(legend.position = 'top', legend.box.margin = margin(b = 20))

ggsave(paste0('PoS_2T_sim2_', 100*rho, '.pdf'), PoS_plots,
              width = 28, height = 18, units = "cm", device = cairo_pdf)
...
save(dPoS, mPoS.H1, mPoS.H2,
     file = paste0('2_treatments_sim3_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p1.H1 + p1.H2 + 
  ...
  plot_annotation(title = paste0("<b>&theta;</b> = (&theta;, &theta;) and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) +
  plot_layout(guides = "collect") &
  theme(legend.position = 'top', legend.box.margin = margin(b = 20))


ggsave(paste0('PoS_2T_sim3_', 100*rho, '.pdf'), PoS_plots,
              width = 28, height = 18, units = "cm", device = cairo_pdf)
...
save(dPoS, file = paste0('3_treatments_sim1_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p2 + 
  plot_annotation(title = "<b>&theta;</b> = (0, 0, &theta;) and &rho; = 0.75",
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) +
  plot_layout(nrow = 2)

ggsave(paste0('dPoS_3T_sim1_', 100*rho, '.pdf'), PoS_plots,
       width = 20, height = 16, units = "cm", device = cairo_pdf)
...
save(dPoS, mPoS.H1, mPoS.H2, mPoS.H3, w.bonf,
     file = paste0('3_treatments_sim2_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p2 + plot_layout(nrow = 2) +
  plot_annotation(title = paste0("<b>&theta;</b> = (&theta;/2, &theta;, 2&theta;) and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19)))

ggsave(paste0('dPoS_3T_sim2_', 100*rho, '.pdf'), PoS_plots,
              width = 20, height = 16, units = "cm", device = cairo_pdf)
...
p2.H1 <- ggplot(data.H1, aes(x = theta)) +
  geom_line(aes(y = (w.bonf - bonf)), color = 'darkgreen') +
  ylab("Difference in PoS") + xlab(expression(theta)) + 
  labs(color = NULL) + theme(legend.position = "none") + 
...
PoS_plots = p1.H1 + p1.H2 + p1.H3 +                  # Row 1 (A, B, C)
  ...
  plot_annotation(
    title = paste0("<b>&theta;</b> = (&theta;/2, &theta;, 2&theta;) and &rho; = ", rho),
    theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))
  ) & theme(legend.position = 'top', legend.box.margin = margin(b = 20))


ggsave(paste0('mPoS_3T_sim2_', 100*rho, '.pdf'), PoS_plots,
       width = 24, height = 22, units = "cm", device = cairo_pdf)
...
save(dPoS, n.NA,
     file = paste0('5treatments_sim1_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p2 + 
  plot_annotation(title = paste0("<b>&theta;</b> = (0, 0, 0, 0, &theta;) and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) + 
  plot_layout(nrow = 2)

ggsave(paste0('PoS_5T_sim1_', 100*rho, '.pdf'), PoS_plots,
       width = 20, height = 16, units = "cm", device = cairo_pdf)
...
save(dPoS, mPoS.H5, n.NA,
     file = paste0('5treatments_sim2_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p1.H5 + p2 + p2.H5 +
  plot_annotation(title = paste0("<b>&theta;</b> = (0, 0, &theta;, &theta;, &theta;) and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.5, size = 19))) +
  plot_layout(nrow = 2)

ggsave(paste0('PoS_5T_sim2_', 100*rho, '.pdf'), PoS_plots,
       width = 24, height = 16, units = "cm", device = cairo_pdf)
...
save(dPoS, mPoS.H1, mPoS.H5, n.NA,
     file = paste0('5treatments_sim3_', 100*rho, '.Rdata'))
...
PoS_plots = p1 + p1.H5 + p2 + p2.H5 + 
  plot_layout(nrow = 2) +
  plot_annotation(title = paste0("<b>&theta;</b> = (&theta;<sub>1</sub>, &theta;<sub>2</sub>, &theta;<sub>3</sub>, &theta;<sub>4</sub>, &theta;<sub>5</sub>) with &theta;<sub>i</sub> &#126; U[0, &theta;] and &rho; = ", rho),
                  theme = theme(plot.title = element_markdown(hjust = 0.4, size = 17)))


ggsave(paste0('PoS_5T_sim3_', 100*rho, '.pdf'), PoS_plots,
              width = 24, height = 16, units = "cm", device = cairo_pdf)
